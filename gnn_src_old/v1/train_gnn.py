...
def train_gnn(
    ...
    for epoch in range(epochs):
        ...
        for data in train_loader:
            ...
            x_reconstructed = torch.matmul(node_emb, node_emb.t())
            loss = F.mse_loss(x_reconstructed, torch.matmul(data.x, data.x.t()))
...
if __name__ == "__main__":
    data_path = "/home/naradalinux/dev/Graph_TFT/data/processed/data_w_geo.csv"
    output_dir = "/home/naradalinux/dev/Graph_TFT/data/embeddings"
