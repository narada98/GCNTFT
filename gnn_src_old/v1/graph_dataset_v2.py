...
class AirQualityGraphDataset:
    def __init__(
        ...
        connection_radius: float = 1000.0,  # in kilometers
    ...
    def _create_graphs(self) -> List[Data]:
        ...
        min_windows = min(len(features) for features in node_features_by_station)
        ...
        graphs = []
        for time_idx in range(len(node_features_by_station[0])):
